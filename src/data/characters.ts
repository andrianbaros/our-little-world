...
export const CHARACTERS_DATA: CharacterPersonality[] = [
...

  {
    ...
    favorite: {
      id: 'Headphone retro mint-teal, kacamata hitam retro, mixtape lo-fi estetik, dan es teh buah persik',
      en: 'Chic retro mint-teal headphones, retro shades, aesthetic lo-fi mixtapes, and peach iced tea',
      km: 'កាស retro mint-teal វ៉ែនតាខ្មៅ អាល់ប៊ុម lo-fi និងតែផ្លែប៉េសត្រជាក់',
    },
    funFact: {
