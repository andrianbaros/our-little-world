...
export const CHARACTERS_DATA: CharacterPersonality[] = [
...

  {
    ...
    tagline: {
      id: 'Si lembut yang hobi rebahan di awan paling empuk sedunia.',
      en: 'The soft sleepyhead drifting on the fluffiest marshmallow cloud.',
      km: 'អ្នកទន់ភ្លន់ដែលចូលចិត្តគេងនៅលើដុំពពកដ៏ទន់បំផុតក្នុងលោក។',
    },
    personality: {
    ...
    speechText: {
      ...
      en: 'Yaaawn... are you sleepy too? Come snuggle on this cloud with Momo.',
      km: 'ស្ងាប... អ្នកងងុយគេងដែរមែនទេ? មកគេងក្បែរម៉ូម៉ូនៅលើពពកនេះមក។',
    },
    idleSpeech: {
      id: [
      ...
      en: [
        ...
        'This cloud cushion is heavenly...'
      ],
      km: [
    ...
    worldPosition: {
      ...
      facing: 'left',
      spotDescription: {
        id: 'Bergelut nyaman di gumpalan awan kapas apung',
        en: 'Curled up happily inside a floating cotton candy cloud',
        km: 'គេងយ៉ាងសុខស្រួលក្នុងដុំពពកសំឡីហោះ',
      },
    },
    soundType: 'yawn',
    specialReaction: {
...

  {
    ...
    worldPosition: {
      ...
      facing: 'right',
      spotDescription: {
        id: 'Di taman bunga mawar sedang menata keranjang pie',
        en: 'Arranging fresh pie baskets in the fragrant rose garden',
        km: 'រៀបចំកន្ត្រកនំនៅក្នុងសួនផ្កាកុលាបដ៏ក្រអូប',
      },
    },
    soundType: 'pop',
    specialReaction: {
