...
export const UI_TRANSLATIONS: Record<Language, {
  ...
  id: {
    ...
    about: {
      ...
      story: 'Our Little World adalah sebuah semesta animasi yang hangat, tempat di mana 12 sahabat mungil tinggal berdampingan. Tidak ada perlombaan di sini—hanya secangkir teh di pagi hari, gelembung sabun yang melayang di udara, petikan musik lo-fi di bawah pohon, dan tawa tulus yang menular.',
    ...
    footer: {
      ...
      sub: '12 Sahabat Kecil, Satu Semesta yang Nyaman',
      backToTop: 'Kembali ke Atas',
    },
    loading: 'Membangunkan 12 sahabat kecil...',
  },

  en: {
    brandTitle: 'OUR LITTLE WORLD',
    brandSub: '12 Cute Friends',
    nav: {
      home: 'HOME',
      world: 'WORLD',
      characters: 'FRIENDS',
    ...
    about: {
      ...
      story: 'Our Little World is a cozy, heartwarming animated universe where 12 friends live together in harmony. There is no rush here—just morning herbal tea, floating soap bubbles, chill beats under shady trees, and genuine smiles.',
    ...
    footer: {
      ...
      sub: '12 Little Characters, One Cozy Universe',
      backToTop: 'Back to Top',
    },
    loading: 'Waking up 12 little friends...',
  },

  km: {
    brandTitle: 'ពិភពលោកតូចរបស់យើង',
    brandSub: 'មិត្តតូចៗ ១២ នាក់',
    nav: {
      home: 'ទំព័រដើម',
      world: 'ពិភពលោក',
    ...
    about: {
      ...
      story: 'ពិភពលោកតូចរបស់យើង គឺជាចក្រវាលគំនូរជីវចលដ៏កក់ក្តៅ ជាទីកន្លែងដែលមិត្តតូចៗ ១២ នាក់រស់នៅជាមួយគ្នាយ៉ាងសុខសាន្ត។ គ្មានការប្រញាប់ប្រញាល់នៅទីនេះទេ—មានតែតែមួយពែងនៅពេលព្រឹក ពពុះសាប៊ូហោះហើរក្នុងខ្យល់ តន្ត្រីស្ងប់ស្ងាត់ក្រោមម្លប់ឈើ និងស្នាមញញឹមដ៏ស្មោះត្រង់។',
    ...
    footer: {
      ...
      sub: 'តួអង្គតូចៗ ១២ នាក់ ក្នុងចក្រវាលដ៏កក់ក្តៅតែមួយ',
      backToTop: 'ត្រឡប់ទៅខាងលើ',
    },
    loading: 'កំពុងដាស់មិត្តតូចៗទាំង ១២ នាក់...',
  },
};
